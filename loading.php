...
<div id="container">
    ...
    <div id="ad" style="width: 60%;margin: -20px auto 0 auto;font-size: 20px;color: #777"><h4 style="border-bottom: 1px #777 solid;color: #555">今日箴言</h4><?php echo Maxim::get(); ?></div>
