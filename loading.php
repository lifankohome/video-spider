...
$festival = file_get_contents('https://www.lifanko.cn/festival2img/index.php?day=' . date('Ymd', time()));
...
<body>
<div id="container">
    <h2 style="margin: 1pc 0 0"><img src="img/logo.png" style="height: 70px;margin-bottom: -27px"> 影视爬虫v4.0<span
            style="font-size: 12px">（2019/6/30 17:27更新 已支持HTTPS）</span></h2>
